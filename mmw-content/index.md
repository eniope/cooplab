...
title: "cooplab.org"
date: 2026-08-23
description: "Le point d'adressage de l'enquête : comment lire les espaces reliés par Cooplab."
...
- **Par une trajectoire** : [D'où je parle](/dossiers/d-ou-je-parle/) revient sur la constitution de la place depuis laquelle cette enquête devient aujourd’hui possible : le déplacement de 2018, une question qui vient de loin, les relations entre penser, agir et habiter, et une vie prise dans l’histoire récente du calcul.
    
- **Par la fabrique documentaire** :  [Comment c'est fabriqué](/dossiers/comment-c-est-fabrique/)  décrit le dispositif sociotechnique par lequel quelque chose qui arrive dans une vie peut devenir trace, donnée, document, relation ou question — et ce que cette transformation engage.
    
- **Par un territoire** : [lisieres.cooplab.org](https://lisieres.cooplab.org) documente plus directement la lisière Sud-Berry/Creuse, ses acteurs, ses initiatives, ses expériences et les questions qui y apparaissent.
    
- **Par la recherche en train de se construire** : [these.cooplab.org](https://these.cooplab.org) accueille la problématisation, les concepts, les méthodes, les généalogies, les hypothèses, les données et leurs mises à l’épreuve.
    
- **Par les billets** : ils saisissent des rencontres, lectures, événements, essais, déplacements de questions ou bifurcations au moment où ils deviennent significatifs dans l’enquête.
...
D’autres espaces, notamment [praxis.encommun.io](https://praxis.encommun.io), **Robustesse et soin** ou [LinkedIn](https://www.linkedin.com/in/st%C3%A9phane-caillaud-26a72648/), correspondent à d’autres inscriptions, pratiques, communautés ou modalités de circulation.

## Des documents qui n’ont pas tous le même statut

Une partie du travail consiste à ne pas confondre ce qui relève :

- d’une trace produite au moment d’un événement ;
    
- d’un document ou d’une source retrouvée ;
    
- de ce que je peux attester ;
    
- d’une interprétation formulée après coup ;
    
- d’une hypothèse de recherche ;
    
- d’une relation que je propose entre plusieurs éléments.
...
- permettre à une personne de comprendre le récit, son contexte, ses incertitudes, ses bifurcations et ses changements de vocabulaire ;
